                ...
                <div class="card server-card">
                    <div class="card-body p-2">
                        <div class="server-header">
                            <div>
                                <h5 class="server-name"><span class="info-btn me-2" onclick="showStrategyInfo(${server.server_num}, event)"><i class="bi bi-info-circle"></i></span>${escapeHtml(server.name)}<span class="activity-star" id="activity-star-${server.server_num}"><i class="bi bi-star-fill"></i></span></h5>
