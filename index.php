                ...
                <div class="card server-card">
                    <div class="card-body p-2">
                        <div class="server-header">
                            <div>
                                <h5 class="server-name">${server.bybit_id ? `<a href="https://www.bybit.com/copyTrade/trade-center/detail?leaderMark=${encodeURIComponent(server.bybit_id)}" target="_blank" onclick="event.stopPropagation()"><img src="https://www.bybit.com/bycsi-root/fop/copytrade/${server.bybit_id}.png?format=avif&quality=40" class="bybit-avatar" onerror="this.style.display='none'"></a>` : ''}<span class="info-btn me-2" onclick="showStrategyInfo(${server.server_num}, event)"><i class="bi bi-info-circle"></i></span>${escapeHtml(server.name)}<span class="activity-star" id="activity-star-${server.server_num}"><i class="bi bi-star-fill"></i></span></h5>
